            ...
            <div className="container mx-auto px-6 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {popularRoutes.map((route, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col items-center justify-center">
                            <img src={route.image} alt={`${route.origin} to ${route.destination}`} className="w-[50px] mx-auto my-[30px] object-contain" />
                            <div className="p-6">
